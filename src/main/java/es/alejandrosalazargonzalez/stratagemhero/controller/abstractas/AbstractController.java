package es.alejandrosalazargonzalez.stratagemhero.controller.abstractas;

import java.io.IOException;
import java.util.Properties;

import es.alejandrosalazargonzalez.stratagemhero.PrincipalApplication;
import es.alejandrosalazargonzalez.stratagemhero.config.ConfigManager;
import es.alejandrosalazargonzalez.stratagemhero.model.UsuarioServiceModel;
